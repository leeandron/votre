	...
	public function triggerSizeGuide()
	{
		...
		if ( $hide != 'yes' || $productAvailability['class'] != 'out-of-stock' ) {
			...
			if ($trigger == 'ct-trigger-button') {
				...
				$output = '<a class="open-popup-link ' . $this->getSgOption('wc_size_guide_button_class', 'button_sg') . '" href="#ct_size_guide" style="float: ' . $align . '; ' . $margins . '">' . $this->getSgOption("wc_size_guide_button_label", esc_html__( "Size Guide", "ct_sgp" ) ) . '</a>';
			} else {
				$output = '<a class="open-popup-link" href="#ct_size_guide" style="float: ' . $align . '; ' . $margins . '">' . $this->getSgOption("wc_size_guide_button_label", esc_html__( "Size Guide", "ct_sgp" ) ) . '</a>';
			}
			if ($clear == 'no') {
